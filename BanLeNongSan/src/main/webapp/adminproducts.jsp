...
<body>
                    ...
                    <tbody>
                        <c:forEach var="p" items="${listProducts}">
                            <tr>
                                ...
                                <td>
                                    <c:choose>
                                        <c:when test="${p.trangThai == 'Đang bán'}">
                                ...
                                <td class="text-end pe-4">
                                    ...
                                    <button type="button" class="btn btn-sm btn-outline-primary btn-custom me-1" 
                                            onclick="openEditModal(${p.maSP}, '${p.tenSP}', ${p.maDanhMuc.maDanhMuc}, '${p.donGia}', ${p.soLuongTon}, '${p.donViTinh}', '${p.trangThai}', '${p.hinhAnh}', '${p.moTa}')" title="Sửa sản phẩm">
                                        <i class="bi bi-pencil-square"></i>
                                    </button>
                                    
                                    <!-- Nút Đổi Trạng Thái -->
                                    <button type="button" class="btn btn-sm btn-custom ${p.trangThai == 'Ngừng bán' ? 'btn-success' : 'btn-danger'}" 
                                            onclick="confirmToggleStatus(${p.maSP}, '${p.tenSP}', '${p.trangThai}')" title="${p.trangThai == 'Ngừng bán' ? 'Mở bán lại' : 'Ngừng bán'}">
                                        <i class="bi ${p.trangThai == 'Ngừng bán' ? 'bi-check-circle-fill' : 'bi-x-circle-fill'}"></i>
                                    </button>
                                </td>
                            </tr>
                        </c:forEach>
    ...
    <script>
        ...
        function openEditModal(id, name, catId, price, stock, unit, status, image, desc) {
