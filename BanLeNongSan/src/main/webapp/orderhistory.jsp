...
<html lang="vi">
    <head>
        ...
        <title>Lịch sử đơn hàng - Rau Thép</title>
            ...
            <div class="flex items-center gap-4 shrink-0">
                ...
                <c:choose>
                    <c:when test="${not empty cookie.fullname.value}">
                        <a href="orderhistory" class="text-sm font-bold bg-brand-card px-4 py-2 rounded border border-brand-dark bg-brand text-brand-primary transition flex items-center gap-1">📜 Lịch sử GD</a>
